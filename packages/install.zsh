...
if want_dev
then
    DEV_PACKAGES=(g++ gcc cmake python3 python3-pip fzf tmux neofetch lolcat texlive latexmk texlive-fonts-recommended texlive-fonts-extra texlive-latex-extra)
