...
LATEX_PACKAGES=(latexmk texlive texlive-xetex texlive-fonts-recommended texlive-fonts-extra textlive-latex-extra python3-pygments)
echo "Installing latex packages ($LATEX_PACKAGES)"
sudo apt-get install -y $LATEX_PACKAGES

GENERAL_PACKAGES=(fzf tmux bat)
